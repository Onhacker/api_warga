...
Migration `004` tidak menyimpan kode aktivasi mentah. Provisioning baru membuat kode bersama kredensial dan menaruh nilai mentahnya hanya pada file privat berizin `0600`; server menyimpan hash. Gunakan `tools/issue_enrollment_codes.php` hanya untuk instalasi lama, kode kedaluwarsa, atau penerbitan ulang. Distribusikan satu kode saja kepada desa yang sesuai.
